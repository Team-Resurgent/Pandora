...
namespace Pandora
{
    public class ImGuiController : IDisposable
    {
        ...
        {
            var fontData = ResourceLoader.GetEmbeddedResourceBytes("PandoraOld.Resources.ARIALUNI.TTF", typeof(ImGuiController).GetTypeInfo().Assembly);
        ...
        {
            _splashTexture = CreateTextureFromResource("PandoraOld.Resources.TeamResurgent.jpg");
        }
        ...
        public void CreateDeviceResources()
        {
            ...
            string VertexSource = ResourceLoader.GetEmbeddedResourceString("PandoraOld.Resources.imgui-vertex.glsl");
            string FragmentSource = ResourceLoader.GetEmbeddedResourceString("PandoraOld.Resources.imgui-frag.glsl");
