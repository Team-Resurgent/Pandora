...
namespace Pandora.UI
{
    ...
    {
        public static void SetTeamResurgentTheme()
        {
            ImGui.StyleColorsDark();
            var style = ImGui.GetStyle();
            var colors = style.Colors;
            colors[(int)ImGuiCol.Text] = new Vector4(0.94f, 0.94f, 0.94f, 1.00f);
            colors[(int)ImGuiCol.TextDisabled] = new Vector4(0.93f, 0.87f, 0.93f, 0.28f);
            ...
            colors[(int)ImGuiCol.FrameBgActive] = new Vector4(0.71f, 0.25f, 0.71f, 1.00f);
            colors[(int)ImGuiCol.TitleBg] = new Vector4(0.51f, 0.20f, 0.51f, 1.00f);
            colors[(int)ImGuiCol.TitleBgActive] = new Vector4(0.66f, 0.25f, 0.66f, 1.00f);
            ...
            colors[(int)ImGuiCol.ScrollbarGrabHovered] = new Vector4(0.60f, 0.24f, 0.60f, 1.00f);
            colors[(int)ImGuiCol.ScrollbarGrabActive] = new Vector4(0.60f, 0.24f, 0.60f, 1.00f);
            colors[(int)ImGuiCol.CheckMark] = new Vector4(0.66f, 0.25f, 0.66f, 1.00f);
            ...
            colors[(int)ImGuiCol.ButtonHovered] = new Vector4(0.60f, 0.10f, 0.60f, 1.00f); 
            colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.66f, 0.25f, 0.66f, 1.00f);
            colors[(int)ImGuiCol.Header] = new Vector4(0.60f, 0.24f, 0.60f, 1.00f);
            ...
            colors[(int)ImGuiCol.Tab] = new Vector4(0.67f, 0.23f, 0.67f, 0.95f);
            colors[(int)ImGuiCol.TabHovered] = new Vector4(0.60f, 0.10f, 0.60f, 1.00f);
            colors[(int)ImGuiCol.TabActive] = new Vector4(0.60f, 0.10f, 0.60f, 1.00f);
            colors[(int)ImGuiCol.TabUnfocused] = new Vector4(0.54f, 0.21f, 0.54f, 0.99f);
            colors[(int)ImGuiCol.TabUnfocusedActive] = new Vector4(0.60f, 0.24f, 0.60f, 1.00f);
            colors[(int)ImGuiCol.PlotLines] = new Vector4(0.93f, 0.86f, 0.93f, 0.63f);
            colors[(int)ImGuiCol.PlotLinesHovered] = new Vector4(0.71f, 0.27f, 0.71f, 1.00f);
            colors[(int)ImGuiCol.PlotHistogram] = new Vector4(0.93f, 0.86f, 0.93f, 0.63f);
            colors[(int)ImGuiCol.PlotHistogramHovered] = new Vector4(0.71f, 0.27f, 0.71f, 1.00f);
            colors[(int)ImGuiCol.TextSelectedBg] = new Vector4(0.66f, 0.26f, 0.66f, 1.00f);
